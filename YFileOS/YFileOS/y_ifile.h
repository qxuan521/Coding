...
public:
	...
	virtual const std::uint32_t		getChildrenFolderCount() = 0;
	virtual const std::uint32_t		getChildrenFileCount() = 0;
	virtual const std::string&		getName() = 0;
	virtual const std::string		getShowName() = 0;
	virtual	YIFile*					getParent() = 0;
